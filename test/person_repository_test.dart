...
void main() {
  ...
  test('deve pegar uma lista de person', () async {
    when(() => client.get(Uri.parse('https://62afa00db0a980a2ef424a47.mockapi.io/api/v1/person'))).thenAnswer((_) async => http.Response(jsonReturn, 200));
  ...
  test('retorna uma exception se nao for statuCode 200', () async {
    when(() => client.get(Uri.parse('https://62afa00db0a980a2ef424a47.mockapi.io/api/v1/person'))).thenAnswer((_) async => http.Response(jsonReturn, 404));
